...
echo "Backend API: https://$(oc get route nodejs-route -n music-game-spotify -o jsonpath='{.spec.host}')"
echo "Admin Panel: https://$(oc get route nginx-route -n music-game-spotify -o jsonpath='{.spec.host}')/admin"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
